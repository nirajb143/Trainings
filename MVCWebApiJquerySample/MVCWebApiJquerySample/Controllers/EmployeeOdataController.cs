...
namespace MVCWebApiJquerySample.Controllers
{
    ...
    */
    public class EmployeeOdataController : ODataController
    {
        ...
        // GET odata/EmployeeOdata
        [Queryable]
        public IQueryable<Employee> GetEmployeeOdata()
        {
            return db.Employees;
        }

        // GET odata/EmployeeOdata(5)
        [Queryable]
